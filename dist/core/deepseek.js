export class DeepSeekAiAgent {
    ...
    constructor(apiKey) {
        ...
        console.log(`Using DeepSeek model: ${this.model}`);
    }
    ...
    `;
        try {
            ...
            if (!response.ok) {
                ...
                return `DeepSeek Error: ${response.status} ${response.statusText} ${JSON.stringify(errorData)}`;
            }
            ...
            try {
                ...
                return `DeepSeek Parse Error: Invalid JSON response - ${content}`;
            }
        }
        catch (error) {
            return `DeepSeek Network Error: ${error.message || error}`;
        }
    }
}
